...
function checkAnswer() {
  ...
  if (userAnswer === 'een planeet is een groot object dat rond een ster draait en zijn omgeving schoon heeft geveegd van ander puin. Een dwergplaneet is vergelijkbaar met een planeet, maar heeft niet genoeg zwaartekracht om zijn baan schoon te vegen en wordt vaak omringd door ander puin.') {
